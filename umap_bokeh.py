...
bar_data=((df["label"].value_counts()/df["label"].value_counts().sum())*100).reset_index()
...
def update_plot():
    ...
    new_bar_data=((new_df["label"].value_counts()/new_df["label"].value_counts().sum())*100).reset_index()
